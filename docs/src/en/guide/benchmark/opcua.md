...
This page provides benchmark results for the OPC UA protocol on `ng-gateway`. The tests aim to evaluate the gateway's throughput, latency, and resource consumption as an OPC UA client under various workloads.
...
```bash
# Ensure OPC UA Server is running and accessible
# Replace <YOUR_ENDPOINT_URL> with actual address
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 1 --duration-secs 60`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 2 --duration-secs 60`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 3 --duration-secs 120`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 4 --duration-secs 60`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 5 --duration-secs 60`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 6 --duration-secs 60`
...
*   **Command**: `cargo run --release --bin ng-gateway-bench -- --protocol opcua --scenario 7 --duration-secs 60`
...
|---:|---|---:|---:|---:|---|---:|---|---|---|---|
| 1 | opcua | 1 | 10 | 1000 | 1000 ms | 10000 | Float32 | (TBD) | (TBD) | (TBD) |
| 2 | opcua | 5 | 10 | 1000 | 1000 ms | 50000 | Float32 | (TBD) | (TBD) | (TBD) |
| 3 | opcua | 10 | 10 | 1000 | 1000 ms | 100000 | Float32 | (TBD) | (TBD) | (TBD) |
| 4 | opcua | 1 | 1 | 1000 | 100 ms | 1000 | Float32 | (TBD) | (TBD) | (TBD) |
| 5 | opcua | 5 | 1 | 1000 | 100 ms | 5000 | Float32 | (TBD) | (TBD) | (TBD) |
| 6 | opcua | 10 | 1 | 1000 | 100 ms | 10000 | Float32 | (TBD) | (TBD) | (TBD) |
| 7 | opcua | 10 | 10 | 1000 | 1000 ms | 100000 | Float32 | (TBD) | (TBD) | (TBD) |
